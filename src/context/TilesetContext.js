...
import './TilesetCreator.css'; // We'll reuse the existing CSS
...
const TileEditorCard = ({ tile, onUpdate, onRemove }) => {
  ...
  return (
    // Standardizing the card structure to match other editors
    <div className="creator-card">
      ...
      <div className="creator-card-body">
        ...
        <div className="checkbox-grid-4-cols">
            {/* THE FIX: Standardizing property names to match Cell.js */}
